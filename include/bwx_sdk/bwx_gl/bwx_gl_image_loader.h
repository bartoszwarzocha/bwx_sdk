...
enum bwxGL_IMG_ROTATE_MODE { IMG_ROTATE0, IMG_ROTATE90, IMG_ROTATE180, IMG_ROTATE270 };
...
public:
    ...
    bool Load(const wxString& file, bwxGL_IMG_ROTATE_MODE rotate = bwxGL_IMG_ROTATE_MODE::IMG_ROTATE0,
              bool forcePowerOf2 = false);
