...
namespace bwx_sdk {
    ...
    public:
		...
		* @tparam Args Arguments for the component
		* @param args Arguments for the component
		* @return std::shared_ptr<T> Shared pointer to the component
		* @note The component must derive from bwxGLComponent and must be added before the node is added to the scene
        */
